  ...
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon-user-md"></i> <span>Ressources Humaines</span> <span class="label label-important"></span></a>
      <ul>
        ...
        <li> <a href="affectation.php"><i class="icon-hand-right"></i>&nbsp;&nbsp;Ré-affectation des intérimaires</a></li>
    ...
    <li> <a href="erapport.php"><i class="icon-tasks"></i> <span>Génération du erapport</span> <span class="label label-important"></span></a>
