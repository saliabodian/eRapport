<div>
    <div id=>
        <hr>
        <h2>
            <img src="img/logo.png" alt="Logo"  height="42" width="80"> &nbsp;&nbsp; Rapport journalier du <?= $rapportJournalierDate ?> / Noyau : <?= $chefDequipeMatricule ?> / Chantier : <?= $_GET["chantier_code"] ?>
        </h2>
    </div>
    <div>
        <hr>
            ...
            <div>
                <div>
                    <?php if(!empty($rapportNoyau)){ ?>
                        <div>
                            <div>
                                <h3>Rapport journalier du noyau</h3>
                            </div>
                            <div>
            ...
            <div>
                <div>
                    <?php if(!empty($rapportNoyauAbsent)){ ?>
                        <div>
                            <div>
                                <h3 style="page-break-before: always;">Rapport journalier des absents du noyau</h3>
                            </div>
                            <div>
                                <form method="post" action="rapportDetail.php">
                                    ...
                                    <table style="page-break-inside: avoid; border: 1px; border-collapse: collapse;">
                                        ...
                                        <?php  endforeach;  ?>
                                            <tr>
                                            <td style="text-align: left;  border:solid 1px #000000; color: red; "><b>&nbsp;Totaux</b></td>
                                            <td style="text-align: center;  border:solid 1px #000000; color: red; "><b><?= $absentHourGlobal; ?></b></td>
                                            <?php if(!empty($noyauAbsentHeader)) :?>
                                                <?php foreach($noyauAbsentHeader as $noyauHeaderdetail) : ?>
                                                    <td style="text-align: center;  border:solid 1px #000000; color: red; "><?= $noyauHeaderdetail['vht'] ?></b></td>
                                                <?php endforeach ; ?>
                                            <?php endif ; ?>
                                            <td style="text-align: center;  border:solid 1px #000000; color: red; "><b><?= $absentHourAbsencesGlobal; ?></b></td>
                                            <td style="text-align: center;  border:solid 1px #000000; color: red; "><b><?= $absentHourPenibleGlobal; ?></b></td>
                                            <td style="text-align: center;  border:solid 1px #000000; color: red; "><b><?= $absentKmGlobal; ?></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                    <hr>
            ...
            <div>
                <div>
                    <?php if(!empty($rapportAbsentHorsNoyau)){ ?>
                        <div>
                            <div>
                                <h3 style="page-break-before: always;">Rapport journalier des absents hors noyau</h3>
                            </div>
                            <div>
                                <form method="post" action="rapportDetail.php">
                                    ...
                                    <table style="page-break-inside: avoid; border: 1px; border-collapse: collapse;"  autosize="1">
                                        ...
                                        <?php  endforeach;  ?>
                                            <tr>
                                            <td style="text-align: left;  border:solid 1px #000000; color: red; "><b>&nbsp;Totaux</b></td>
                                            <td style="text-align: center;  border:solid 1px #000000; color: red; "><b><?= $absentHorsNoyauHourGlobal; ?></b></td>
                                            <?php if(!empty($absentHorsNoyauHeader)) :?>
                                                <?php foreach($absentHorsNoyauHeader as $noyauHeaderdetail) : ?>
                                                    <td style="text-align: center;  border:solid 1px #000000; color: red; "><b><?= $noyauHeaderdetail['vht'] ?></b></td>
                                                <?php endforeach ; ?>
                                            ...
                                            <td style="text-align: center;  border:solid 1px #000000; color: red; "><b><?= $absentHorsNoyauHourPenibleGlobal; ?></b></td>
                                            <td style="text-align: center;  border:solid 1px #000000; color: red; "><b><?= $absentHorsNoyauKmGlobal; ?></b></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                    <hr>
            ...
            <div>
                <div>
                    <?php if(!empty($rapportHorsNoyau)){ ?>
                        <div>
                            <div>
                                <h3 style="page-break-before: always;">Rapport journalier des hors noyau</h3>
                            </div>
                            <div>
                                <form method="post" action="rapportDetail.php">
                                    <input type="hidden" name="rapport_id" value="<?= $_GET['rapport_id']?>"/>
