...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var fieldHTML = '<div class="control-group"><div class="controls"><input type="text" class="span4" placeholder="Batiment" name="bat[]"/><a href="javascript:void(0);" class="remove_button"><img src="img/moins-mini.png"></i></a></div></div>'; //New input field html
